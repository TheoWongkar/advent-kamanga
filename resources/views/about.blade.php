            ...
            <div class="flex flex-wrap justify-center gap-8">
                ...
                <div
                    ...
                    <div class="flex justify-center mb-4">
                        <svg class="w-12 h-12 text-blue-900" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12 2L2 7l10 5 10-5-10-5zm0 7.84l-7.76-3.8 7.76-3.8 7.76 3.8-7.76 3.8zm-9.76 4.82L12 19.66l9.76-4.8V22H2.24v-7.34zM22 8.23l-10 5-10-5v2.61l10 5 10-5V8.23z">
                            </path>
                        </svg>
                    </div>
                ...
                <div
                    ...
                    <div class="flex justify-center mb-4">
                        <svg class="w-12 h-12 text-blue-900" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12 3a9 9 0 019 9 9 9 0 01-9 9 9 9 0 01-9-9 9 9 0 019-9zm0-2a11 11 0 100 22A11 11 0 0012 1zm-2 10H8v2h2v5h2v-5h2v-2h-2V7h-2v4z">
                            </path>
                        </svg>
                    </div>
                ...
                <div
                    ...
                    <div class="flex justify-center mb-4">
                        <svg class="w-12 h-12 text-blue-900" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22c-5.514 0-10-4.486-10-10S6.486 2 12 2s10 4.486 10 10-4.486 10-10 10zm-5-9h3v5h2v-5h3l-4-4-4 4z">
                            </path>
                        </svg>
                    </div>
